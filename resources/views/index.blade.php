{{--
 ...
 --}}
        ...
        {{-- <!-- Afiseaza toate testele -->
@foreach($all_test_blogs as $test_blog)
<!-- Afiseaza detaliile testului -->
{{ $test_blog->title }}
@endforeach --}}

<!-- Afiseaza primele 2 teste -->
  ...
  <header class=" lh-1 py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 pt-1">
        <a class="link-secondary text-white" href="aboutus">About Us</a>
      </div>
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
            @auth
                <a href="{{ url('/dashboard') }}" class="btn btn-sm btn-outline-dark mx-2">profile</a>
            @else
                <a href="{{ route('login') }}" class="btn btn-sm btn-outline-dark mx-2">Log in</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="btn btn-sm btn-outline-dark mx-2">Register</a>
                @endif
            @endauth
        </div>
    @endif
    ...
    <form action="{{ route ('logout') }}" method="POST">
        @csrf
        <button class="btn btn-sm btn-outline-dark mx-2">Logout</button>
    </form>
    @endauth
...
{{--                                              --}}
@foreach($first_test_blogs as $test_blog)
              <h1 class="display-4 fst-italic">{{ $test_blog->title }}</h1>
              <p class="lead my-3">{{ $test_blog->content }}</p>
@endforeach
...
--}}
          ...
          <div class="row">
            @foreach($first_2_test_blogs as $test_blog)
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative bg_card">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <h3 class="mb-0">{{ $test_blog->title }}</h3>
                        <div class="mb-1 text-body-secondary">Nov 12</div>
                        <p class="card-text mb-auto">{{ $test_blog->content }}</p>
                        <a href="testview.php?id=id" class="icon-link gap-1 icon-link-hover stretched-link">Continue reading<svg class="bi"><use xlink:href="#chevron-right"/></svg></a>
                    </div>
...
<section class="cards_backgrounds">
    <div class="container py-4">
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="../images/2.jpg" class="card-img-top" alt="Image Title">
                    <div class="card-body">
                        <h5 class="card-title">Title</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, fugiat asperiores inventore beatae accusamus odit minima enim, commodi quia, doloribus eius! Ducimus nemo accusantium maiores velit corrupti tempora reiciendis molestiae repellat vero.</p>
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    <img src="../images/3.jpg" class="card-img-top" alt="Image Title">
                    <div class="card-body">
                        <h5 class="card-title">Title</h5>
                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, fugiat asperiores inventore beatae accusamus odit minima enim, commodi quia, doloribus eius! Ducimus nemo accusantium maiores velit corrupti tempora reiciendis molestiae repellat vero.</p>
                        <a href="#" class="btn btn-primary">Read More</a>
